...
?>
<?php
	$con = mysqli_connect("103.53.40.64","cromag8l_fees","cromag8l_fees@123#","cromag8l_fees") or die("Could not connect.");
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
							...
							<div class="col-lg-3">
                              ...
                              <div class="col-lg-3">
								<div class="form-group">
									<label for="pwd">How Many Months of Experience</label>
                              ...
                              <div class="col-lg-3">
                                ...
                                <input type="text" class="form-control my-from" name="annual_package" id="annualPackd" placeholder="Enter Annual Package" onkeypress="return isNumberKey(event);" maxlength="7" value="<?php if(!empty($row['emp_ctc3'])){ echo $row['emp_ctc3']; }else if($_POST['annual_package']){ echo $_POST['annual_package']; } ?>" readonly>
                              </div>
                              </div>
                              <div class="col-lg-6">
                                <div class="form-group">
                              ...
                              <div class="col-lg-12" style="display:none;">
                                <div class="form-group">
                                    ...
                                    <textarea  name="brief_work" cols="100" rows="1" id="briefWorkd" placeholder="Enter Explanation Your work (Optional)">NA</textarea>
                              </div>
                              </div>
                        ...
                        <div class="col-lg-3">
							...
							<div class="col-lg-3">
                              ...
                              <div class="col-lg-12" style="display:none;">
                                <div class="form-group">
                                <label for="pwd">Give A Brief Explanation About Your work</label>
                               <textarea  name="brief_work" cols="100" rows="1" id="briefWork" placeholder="Enter Explanation Your work (Optional)" readonly class="form-control">NA</textarea>
                              </div>
                              </div>
		...
		$.ajax({	
			...
			success:function(response){
				...
				if(obj.status){
			    	...
			    	window.location.href = "https://exps.cromacampus.com/thanku.php";
